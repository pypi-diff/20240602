# Comparing `tmp/pyoload-1.1.0.tar.gz` & `tmp/pyoload-1.1.2.tar.gz`
...
+gzip compressed data, was "pyoload-1.1.2.tar", last modified: Sun Jun  2 09:00:52 2024, max compression
```

## Comparing `pyoload-1.1.0.tar` & `pyoload-1.1.2.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-06-02 09:00:52.282750 pyoload-1.1.2/
+-rw-r--r--   0 runner    (1001) docker     (127)     1049 2024-06-02 09:00:50.000000 pyoload-1.1.2/LICENSE
+-rw-r--r--   0 runner    (1001) docker     (127)     8321 2024-06-02 09:00:52.282750 pyoload-1.1.2/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (127)     6516 2024-06-02 09:00:50.000000 pyoload-1.1.2/README.md
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-06-02 09:00:52.278750 pyoload-1.1.2/pyoload/
+-rw-r--r--   0 runner    (1001) docker     (127)    18975 2024-06-02 09:00:47.000000 pyoload-1.1.2/pyoload/__init__.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-06-02 09:00:52.282750 pyoload-1.1.2/pyoload.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (127)     8321 2024-06-02 09:00:52.000000 pyoload-1.1.2/pyoload.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (127)      262 2024-06-02 09:00:52.000000 pyoload-1.1.2/pyoload.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (127)        1 2024-06-02 09:00:52.000000 pyoload-1.1.2/pyoload.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (127)      185 2024-06-02 09:00:52.000000 pyoload-1.1.2/pyoload.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (127)        8 2024-06-02 09:00:52.000000 pyoload-1.1.2/pyoload.egg-info/top_level.txt
+-rw-r--r--   0 runner    (1001) docker     (127)       38 2024-06-02 09:00:52.282750 pyoload-1.1.2/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (127)     2529 2024-06-02 09:00:47.000000 pyoload-1.1.2/setup.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-06-02 09:00:52.282750 pyoload-1.1.2/tests/
+-rw-r--r--   0 runner    (1001) docker     (127)      597 2024-06-02 09:00:47.000000 pyoload-1.1.2/tests/test_cast.py
+-rw-r--r--   0 runner    (1001) docker     (127)      668 2024-06-02 09:00:47.000000 pyoload-1.1.2/tests/test_check.py
+-rw-r--r--   0 runner    (1001) docker     (127)     1143 2024-06-02 09:00:47.000000 pyoload-1.1.2/tests/test_overload.py
```

### Comparing `pyoload-1.1.0/LICENSE` & `pyoload-1.1.2/LICENSE`

 * *Files identical despite different names*

### Comparing `pyoload-1.1.0/pyoload/__init__.py` & `pyoload-1.1.2/pyoload/__init__.py`
...
### Comparing `pyoload-1.1.0/setup.py` & `pyoload-1.1.2/setup.py`
