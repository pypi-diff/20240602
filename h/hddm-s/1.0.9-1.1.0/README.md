# Comparing `tmp/hddm_s-1.0.9.tar.gz` & `tmp/hddm_s-1.1.0.tar.gz`
...
## Comparing `hddm_s-1.0.9.tar` & `hddm_s-1.1.0.tar`
...
### Comparing `hddm_s-1.0.9/LICENSE` & `hddm_s-1.1.0/LICENSE`

 * *Files identical despite different names*

### Comparing `hddm_s-1.0.9/PKG-INFO` & `hddm_s-1.1.0/PKG-INFO`
...
### Comparing `hddm_s-1.0.9/README.md` & `hddm_s-1.1.0/README.md`

 * *Files identical despite different names*

### Comparing `hddm_s-1.0.9/hddm_s.egg-info/PKG-INFO` & `hddm_s-1.1.0/hddm_s.egg-info/PKG-INFO`
...
### Comparing `hddm_s-1.0.9/pyproject.toml` & `hddm_s-1.1.0/pyproject.toml`
